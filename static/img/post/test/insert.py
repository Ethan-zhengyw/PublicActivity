...
def example1():
	name = "衣旧暖心"
	create_time = time.strptime('2015-03-01', '%Y-%m-%d')
	start_time = time.strptime('2015-03-21', '%Y-%m-%d')
	deadline = time.strptime('2015-03-31', '%Y-%m-%d')
	...
	activity = Activity(name=name,create_time=create_time,start_time=start_time,deadline=deadline,introduction=introduction,host=host,location=location,isPass=isPass,post=post)
	activity.save()
